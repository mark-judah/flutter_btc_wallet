...
class WalletBalanceLoadingComponent extends StatefulWidget {
  String walletName;
  WalletBloc walletBloc;
  String walletAddress;

  WalletBalanceLoadingComponent(this.walletName,this.walletBloc,this.walletAddress ,{Key? key}) : super(key: key);
  @override
  _MyAppState createState() => _MyAppState();
}

class _MyAppState extends State<WalletBalanceLoadingComponent> {
  @override
  void initState() {
    super.initState();
  }
