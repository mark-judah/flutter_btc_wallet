...
class NavigateToHomePageComponent extends StatefulWidget {
  String walletName;
  WalletBloc walletBloc;
  String walletAddress;

   NavigateToHomePageComponent(this.walletName,this.walletBloc,this.walletAddress,
...
class _MyAppState extends State<NavigateToHomePageComponent> {
  @override
  void initState() {
    super.initState();
  }
                  ...
                  Expanded(
                      child: MaterialButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => ReceiveBitcoin(widget.walletAddress)),
                          );
                        },
                        child: Row(
                          children: const [
